...
ARG KNOWAGE_VERSION="7_0_0"
ARG KNOWAGE_REPO_VERSION="7.0.0"
ARG KNOWAGE_EDITION="CE"
ARG KNOWAGE_RELEASE_DATE="20191022"
...
ARG KNOWAGE_MYSQL_SCRIPT_URL="${KNOWAGE_OW2_DDL_URL}/mysql-dbscripts-${KNOWAGE_VERSION}-20191220.zip"
