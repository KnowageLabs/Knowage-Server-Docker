...
RUN wget "${KNOWAGE_CORE_URL}" && \
       unzip ${KNOWAGE_CORE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_BIRTREPORT_URL}" && \
       unzip ${KNOWAGE_BIRTREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_COCKPIT_URL}" && \
       unzip ${KNOWAGE_COCKPIT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_COMMONJ_URL}" && \
       unzip ${KNOWAGE_COMMONJ_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_DATAMINING_URL}" && \
       unzip ${KNOWAGE_DATAMINING_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_GEOREPORT_URL}" && \
       unzip ${KNOWAGE_GEOREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_JASPERREPORT_URL}" && \
       unzip ${KNOWAGE_JASPERREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_KPI_URL}" && \
       unzip ${KNOWAGE_KPI_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_META_URL}" && \
       unzip ${KNOWAGE_META_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_NETWORK_URL}" && \
       unzip ${KNOWAGE_NETWORK_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_QBE_URL}" && \
       unzip ${KNOWAGE_QBE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_SVGVIEWER_URL}" && \
       unzip ${KNOWAGE_SVGVIEWER_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_TALEND_URL}" && \
       unzip ${KNOWAGE_TALEND_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
...
RUN wget "${KNOWAGE_WHATIF_URL}" && \
       unzip ${KNOWAGE_WHATIF_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && \
