...
* ```6.1.1``` : [Dockerfile](https://github.com/KnowageLabs/Knowage-Server-Docker/master/6.1.1/Dockerfile)
* ```develop``` : [Dockerfile](https://github.com/KnowageLabs/Knowage-Server-Docker/master/Dockerfile)
...
* ```6.1.1``` : [docker-compose](https://github.com/KnowageLabs/Knowage-Server-Docker/master/6.1.1/docker-compose.yml)
* ```develop``` : [docker-compose](https://github.com/KnowageLabs/Knowage-Server-Docker/master/docker-compose.yml)
