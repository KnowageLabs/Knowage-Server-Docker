...
xmlstarlet ed -P -L \
        -u "//Server/GlobalNamingResources/Resource[@name='jdbc/knowage']/@url"             -v "jdbc:mariadb://${DB_HOST}:${DB_PORT}/${DB_DB}?disableMariaDbDriver" \
        -u "//Server/GlobalNamingResources/Resource[@name='jdbc/knowage']/@driverClassName" -v "org.mariadb.jdbc.Driver" \
