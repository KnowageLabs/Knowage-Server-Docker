...
xmlstarlet ed -P -L \
        -u "//Server/GlobalNamingResources/Resource[@name='jdbc/knowage']/@url"             -v "jdbc:oracle:thin:@//${DB_HOST}:${DB_PORT}/${DB_DB}" \
        -u "//Server/GlobalNamingResources/Resource[@name='jdbc/knowage']/@driverClassName" -v "oracle.jdbc.OracleDriver" \
